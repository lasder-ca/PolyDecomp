...
pub fn capabilities() -> Vec<Capability> {
    [
        ...
        ("PE / ELF / Mach-O", "builtin-native-readable", "medium-high", "Recovers functions and CFGs, then applies bounded symbolic propagation, stack-slot naming, condition recovery, fallthrough cleanup and source-like C/Rust/Python rendering."),
        ("Windows PE x64", "builtin-native-readable", "medium-high", "Additionally parses .pdata and PE imports, resolving common RIP-relative IAT calls to DLL/function names while retaining assembly and confidence metadata."),
        ("Go / Rust native", "builtin-native-readable", "medium", "Uses native object analysis plus Go/Rust markers, function recovery, CFGs and the readability pass; no Ghidra/RetDec dependency."),
